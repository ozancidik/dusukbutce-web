...
- Name: auth.test.ts >> Authentication & Authorization Tests >> Login Scenarios >> ❌ Login - Empty fields
...
Call log:
  - Expect "toBeVisible" locator('[data-testid="login-error-message"]') with timeout 3000ms
