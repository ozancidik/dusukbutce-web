...
- Name: auth.test.ts >> Authentication & Authorization Tests >> Login Scenarios >> ❌ Login - Non-existent user
- Location: tests/auth.test.ts:101:9
...
Locator: locator('text=/not.*found|does.*not.*exist|no.*account|hata/i')
Expected: visible
Timeout: 3000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('text=/not.*found|does.*not.*exist|no.*account|hata/i') with timeout 3000ms
  - waiting for locator('text=/not.*found|does.*not.*exist|no.*account|hata/i')
