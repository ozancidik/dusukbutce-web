...
- Name: tests/bize-sat-flow.test.ts >> Bize-Sat Flow Tests >> İlan Oluşturma Senaryoları >> ✅ Fiyat girişi validation
- Location: tests/bize-sat-flow.test.ts:158:9
...
Call log:
  - waiting for getByLabel(/fiyat|price/i)
