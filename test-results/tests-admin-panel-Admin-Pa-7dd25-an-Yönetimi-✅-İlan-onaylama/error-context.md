...
- Name: tests/admin-panel.test.ts >> Admin Panel Testleri >> İlan Yönetimi >> ✅ İlan onaylama
- Location: tests/admin-panel.test.ts:144:9
...
Call log:
  - waiting for getByRole('button', { name: /onayla|approve/i }).first()
