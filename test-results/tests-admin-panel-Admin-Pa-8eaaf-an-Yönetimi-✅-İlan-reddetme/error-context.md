...
- Name: tests/admin-panel.test.ts >> Admin Panel Testleri >> İlan Yönetimi >> ✅ İlan reddetme
- Location: tests/admin-panel.test.ts:157:9
...
Call log:
  - waiting for getByRole('button', { name: /reddet|reject/i }).first()
