...
- Name: tests/admin-panel.test.ts >> Admin Panel Testleri >> Raporlar >> ✅ Rapor dışa aktarma
- Location: tests/admin-panel.test.ts:286:9
...
Call log:
  - waiting for getByRole('button', { name: /dışa|export|download/i })
