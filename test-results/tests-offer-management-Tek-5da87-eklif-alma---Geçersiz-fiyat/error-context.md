...
- Name: tests/offer-management.test.ts >> Teklif (Offer) Yönetimi Testleri >> Teklif Alma Senaryoları >> ❌ Teklif alma - Geçersiz fiyat
- Location: tests/offer-management.test.ts:34:9
