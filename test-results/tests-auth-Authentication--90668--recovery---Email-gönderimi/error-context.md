...
- Name: tests/auth.test.ts >> Authentication & Authorization Tests >> Password Recovery Scenarios >> ✅ Password recovery - Email gönderimi
- Location: tests/auth.test.ts:222:9
...
Call log:
  - waiting for getByText(/forgot.*password|şifremi unuttum/i)
