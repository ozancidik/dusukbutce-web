...
- Name: tests/offer-management.test.ts >> Teklif (Offer) Yönetimi Testleri >> Karşı Teklif Senaryoları >> ✅ Karşı teklif gönderme
- Location: tests/offer-management.test.ts:159:9
...
Call log:
  - waiting for getByRole('button', { name: /karşı teklif|counter|suggest price/i }).first()
