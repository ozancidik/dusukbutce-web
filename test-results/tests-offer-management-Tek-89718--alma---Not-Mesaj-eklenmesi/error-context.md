...
- Name: tests/offer-management.test.ts >> Teklif (Offer) Yönetimi Testleri >> Teklif Alma Senaryoları >> ✅ Teklif alma - Not/Mesaj eklenmesi
- Location: tests/offer-management.test.ts:73:9
