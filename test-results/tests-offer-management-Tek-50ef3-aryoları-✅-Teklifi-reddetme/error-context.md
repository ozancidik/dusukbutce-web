...
- Name: tests/offer-management.test.ts >> Teklif (Offer) Yönetimi Testleri >> Teklif Yönetimi Senaryoları >> ✅ Teklifi reddetme
- Location: tests/offer-management.test.ts:132:9
...
Call log:
  - waiting for getByRole('button', { name: /reddet|reject|decline/i }).first()
