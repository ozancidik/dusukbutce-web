...
- Name: tests/admin-panel.test.ts >> Admin Panel Testleri >> Teklif Yönetimi (Admin) >> ✅ Teklif iptal
- Location: tests/admin-panel.test.ts:246:9
...
Call log:
  - waiting for getByRole('button', { name: /iptal|cancel/i }).first()
