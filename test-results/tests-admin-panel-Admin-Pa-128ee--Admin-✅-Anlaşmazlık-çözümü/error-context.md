...
- Name: tests/admin-panel.test.ts >> Admin Panel Testleri >> Teklif Yönetimi (Admin) >> ✅ Anlaşmazlık çözümü
- Location: tests/admin-panel.test.ts:233:9
...
Call log:
  - waiting for getByRole('button', { name: /anlaşmazlık|dispute|resolver/i }).first()
