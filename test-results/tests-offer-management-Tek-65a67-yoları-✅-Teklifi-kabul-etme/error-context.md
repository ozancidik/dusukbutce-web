...
- Name: tests/offer-management.test.ts >> Teklif (Offer) Yönetimi Testleri >> Teklif Yönetimi Senaryoları >> ✅ Teklifi kabul etme
- Location: tests/offer-management.test.ts:114:9
