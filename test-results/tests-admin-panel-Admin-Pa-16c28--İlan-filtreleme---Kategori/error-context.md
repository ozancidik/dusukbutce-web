...
- Name: tests/admin-panel.test.ts >> Admin Panel Testleri >> İlan Yönetimi >> ✅ İlan filtreleme - Kategori
- Location: tests/admin-panel.test.ts:196:9
...
Call log:
  - waiting for getByLabel(/kategori|category/i)
