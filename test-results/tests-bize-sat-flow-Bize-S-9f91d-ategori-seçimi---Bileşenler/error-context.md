...
- Name: tests/bize-sat-flow.test.ts >> Bize-Sat Flow Tests >> Kategori Listeleme & Navigasyon >> ✅ Kategori seçimi - Bileşenler
- Location: tests/bize-sat-flow.test.ts:48:9
