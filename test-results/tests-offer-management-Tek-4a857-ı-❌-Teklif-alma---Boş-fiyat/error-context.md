...
- Name: tests/offer-management.test.ts >> Teklif (Offer) Yönetimi Testleri >> Teklif Alma Senaryoları >> ❌ Teklif alma - Boş fiyat
- Location: tests/offer-management.test.ts:56:9
