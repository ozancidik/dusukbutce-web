...
### 4. Bot Koruması (Güncellenmiş)
**Rule Name:** Block Bad Bots
**Expression:** `(http.user_agent contains "bot" and not http.user_agent contains "googlebot" and not http.user_agent contains "bingbot" and not http.user_agent contains "facebookexternalhit" and not http.user_agent contains "twitterbot")`
**Action:** Challenge (Captcha)

### 5. Rate Limiting (Güncellenmiş)
**Rule Name:** Rate Limit API
**Expression:** `(http.request.uri.path contains "/api/" and not http.request.uri.path contains "/api/auth/")`
**Action:** Rate Limit (500 requests per 15 minutes)

## 🛡️ Ek Güvenlik Ayarları

### Security Level: Medium (Önerilen: Low)
### Bot Fight Mode: Off (Geçici olarak kapatın)
### Browser Integrity Check: Off (Geçici olarak kapatın)
### Always Use HTTPS: On
### SSL/TLS: Full (strict)
...
### 2. Security Headers (Güncellenmiş)
**URL Pattern:** `dusukbutce.com/*`
**Settings:**
- Security Level: Medium (Geçici olarak Low yapın)
- SSL: Full (strict)
- Always Use HTTPS: On 