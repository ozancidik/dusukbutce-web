        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '18px', color: '#666', marginBottom: '2rem' }}>
              Ürününüzü kargo ile gönderin. Kargo ücreti bizden, güvenli paketleme bizden.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
            <div style={{
              ...
              <h3 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '0.5rem' }}>Kargo Talebi Oluştur</h3>
              <p style={{ color: '#666', marginBottom: '1rem' }}>Kargo bilgilerinizi girin</p>
              <button style={{
                backgroundColor: '#007bff',
                color: 'white',
                border: 'none',
            ...
            <div style={{
              ...
              <a href="https://wa.me/905385793412?text=Kargo ile gönderim için talep oluşturmak istiyorum." 
                 style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(4, 1fr)', gap: '1rem' }}>
              <div style={{ textAlign: 'center' }}>
                ...
                <h4 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '0.25rem' }}>Talep</h4>
                <p style={{ fontSize: '14px', color: '#666' }}>Kargo talebi oluşturun</p>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '24px', marginBottom: '0.5rem' }}>2️⃣</div>
                <h4 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '0.25rem' }}>Paketleme</h4>
                <p style={{ fontSize: '14px', color: '#666' }}>Güvenli paketleme</p>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '24px', marginBottom: '0.5rem' }}>3️⃣</div>
                <h4 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '0.25rem' }}>Kargo</h4>
                <p style={{ fontSize: '14px', color: '#666' }}>Kargo ile gönderim</p>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '24px', marginBottom: '0.5rem' }}>4️⃣</div>
                <h4 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '0.25rem' }}>Ödeme</h4>
                <p style={{ fontSize: '14px', color: '#666' }}>Teslim sonrası ödeme</p>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '18px', fontWeight: 'bold', marginBottom: '1rem', color: '#0066cc' }}>
              💡 Kargo ile Gönderim Avantajları
            </h3>
            <ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#333' }}>
              <li style={{ marginBottom: '0.5rem' }}>Kargo ücreti bizden</li>
              <li style={{ marginBottom: '0.5rem' }}>Güvenli paketleme hizmeti</li>
              <li style={{ marginBottom: '0.5rem' }}>Kargo takip numarası</li>
              <li style={{ marginBottom: '0.5rem' }}>Sigortalı gönderim</li>
