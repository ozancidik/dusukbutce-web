    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ color: '#374151', margin: '0 0 16px 0', fontSize: '20px', fontWeight: '600' }}>
            🔐 Şifre Sıfırlama Bağlantınız Kontrol Ediliyor
        </h2>
          <p style={{ color: '#6b7280', margin: 0, fontSize: '15px', lineHeight: '1.6' }}>
            Email'inizden aldığınız bağlantının geçerliliği kontrol ediliyor. Lütfen kısa bir süre bekleyin.
        </p>
      </div>
    </div>
    </>
