...
export default function GamingWheelPage() {
  ...
  const handleInputChange = (field: string, value: any) => {
    ...
    localStorage.setItem('gamingWheelFormData', JSON.stringify(newData));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!isLoggedIn) {
      router.push('/login?returnUrl=' + encodeURIComponent('/bize-sat/gaming-direksiyon'));
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPopupMessage('Gaming direksiyon ürününüz için teklif talebiniz alındı. En kısa sürede size dönüş yapacağız.');
        setShowPopup(true);
        
        // Form verilerini localStorage'dan temizle
        localStorage.removeItem('gamingWheelFormData');
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Login Required Card */}
        {!isLoggedIn && <LoginRequiredCard isMobile={isMobile} returnUrl="/bize-sat/gaming-direksiyon" />}
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Logitech, Thrustmaster, Fanatec, Hori..."
                  style={{
                    width: '100%',
                    padding: '12px',
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: G29, T300 RS, CSL Elite, Apex..."
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
