...
interface GamingSteeringConditionProps {
  isMobile: boolean;
  formData: {
...
export default function GamingSteeringCondition({ isMobile, formData, handleInputChange }: GamingSteeringConditionProps) {
  return (
