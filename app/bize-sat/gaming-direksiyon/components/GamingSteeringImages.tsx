...
interface GamingSteeringImagesProps {
  isMobile: boolean;
  formData: {
    images: string[];
  };
...
export default function GamingSteeringImages({ isMobile, formData, handleImageUpload, removeImage }: GamingSteeringImagesProps) {
  return (
