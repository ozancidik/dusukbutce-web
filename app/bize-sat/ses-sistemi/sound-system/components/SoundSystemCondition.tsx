...
interface SoundSystemConditionProps {
  isMobile: boolean;
  formData: any;
  handleInputChange: (field: string, value: any) => void;
}

const SoundSystemCondition: React.FC<SoundSystemConditionProps> = ({ isMobile, formData, handleInputChange }) => {
  return (
...
export default SoundSystemCondition;
