...
interface SoundSystemImagesProps {
  isMobile: boolean;
  formData: any;
...
const SoundSystemImages: React.FC<SoundSystemImagesProps> = ({ isMobile, formData, handleImageUpload, removeImage }) => {
  return (
...
export default SoundSystemImages;
