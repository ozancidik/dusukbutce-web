...
export default function SoundSystemPage() {
  ...
  useEffect(() => {
    ...
    const savedFormData = localStorage.getItem('soundSystemFormData');
    if (savedFormData) {
          // JWT token al
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: JBL, Bose, Harman Kardon"
                  style={{
                    width: '100%',
                    padding: '12px',
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Charge 5, SoundLink, Onyx"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Bluetooth Speaker, Soundbar, 2.1"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Bluetooth, AUX, HDMI"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
