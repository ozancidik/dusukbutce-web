...
export default function BuyKeyboardPage() {
  ...
  const [switchTypeValue, setSwitchTypeValue] = useState('');
  ...
  const isFormValid = useMemo(() => {
    ...
    if (!switchTypeValue || switchTypeValue.trim().length < 2) return false;
    if (!manufacturingYearValue || manufacturingYearValue.trim().length < 2) return false;
    return true;
  }, [brandValue, modelValue, switchTypeValue, manufacturingYearValue]);
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: Logitech, Razer, Corsair, SteelSeries..."
                value={brandValue}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: G Pro X, BlackWidow, K70, Apex Pro..."
                value={modelValue}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: Cherry MX Red, Blue, Brown, GX Blue..."
                value={switchTypeValue}
                onChange={(e) => setSwitchTypeValue(e.target.value)}
                style={{
                  width: '100%',
                  padding: isMobile ? '14px 16px' : '16px 20px',
                  border: '1px solid #e2e8f0',
