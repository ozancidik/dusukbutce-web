...
export default function BuyRamPage() {
  // State'ler
  ...
  const isFormValid = useMemo(() => {
    ...
    if (!speedValue || speedValue.trim().length < 2) return false;
    if (!manufacturingYearValue || manufacturingYearValue.trim().length < 2) return false;
    return true;
  }, [brandValue, modelValue, capacityValue, speedValue, manufacturingYearValue]);
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: Vengeance, Fury, Ripjaws..."
                value={modelValue}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: 3200MHz, 3600MHz, 4000MHz..."
                value={speedValue}
