...
interface GamepadConditionProps {
  isMobile: boolean;
  formData: {
...
export default function GamepadCondition({ isMobile, formData, handleInputChange }: GamepadConditionProps) {
  return (
    <div style={{ marginBottom: '32px' }}>
      ...
      <div style={{
        ...
        <div>
          ...
          >
            <option value="">Kozmetik Durum Seçiniz</option>
