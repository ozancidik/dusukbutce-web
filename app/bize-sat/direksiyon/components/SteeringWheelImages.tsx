...
interface SteeringWheelImagesProps {
  isMobile: boolean;
  formData: {
    images: string[];
  };
...
export default function SteeringWheelImages({ isMobile, formData, handleImageUpload, removeImage }: SteeringWheelImagesProps) {
  return (
