...
export default function KeyboardPage() {
  ...
  useEffect(() => {
    ...
    const savedFormData = localStorage.getItem('keyboardFormData');
    if (savedFormData) {
          // JWT token al
    ...
    try {
        ...
        console.log('📝 Kaydedilmiş klavye form verileri yüklendi');
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!isLoggedIn) {
      router.push('/login?returnUrl=' + encodeURIComponent('/bize-sat/klavye'));
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPopupMessage('Klavye ürününüz için teklif talebiniz alındı. En kısa sürede size dönüş yapacağız.');
        setShowPopup(true);
        
        localStorage.removeItem('keyboardFormData');
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Klavyenizi satın, en iyi fiyatı alın
          </p>
        </div>

        {/* Login Required Card */}
        {!isLoggedIn && <LoginRequiredCard isMobile={isMobile} returnUrl="/bize-sat/klavye" />}
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Logitech, Razer, Corsair"
                  style={{
                    width: '100%',
                    padding: '12px',
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: G Pro, BlackWidow, K70"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Klavyeniz için teklif talebiniz alındı. En kısa sürede size ulaşacağız.
            </p>
            <p style={{
              fontSize: '13px',
              color: '#059669',
