...
export default function CasePage() {
  ...
  useEffect(() => {
    ...
    const savedFormData = localStorage.getItem('caseFormData');
    if (savedFormData) {
          // JWT token al
    ...
    try {
        ...
        console.log('📝 Kaydedilmiş kasa form verileri yüklendi');
      } catch (error) {
  ...
  const handleInputChange = (field: string, value: any) => {
    ...
    localStorage.setItem('caseFormData', JSON.stringify(newData));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!isLoggedIn) {
      router.push('/login?returnUrl=' + encodeURIComponent('/bize-sat/kasa'));
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPopupMessage('Kasa ürününüz için teklif talebiniz alındı. En kısa sürede size dönüş yapacağız.');
        setShowPopup(true);
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Boş kasanızı satın, en iyi fiyatı alın
          </p>
        </div>

        {/* Login Required Card */}
        {!isLoggedIn && <LoginRequiredCard isMobile={isMobile} returnUrl="/bize-sat/kasa" />}
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: NZXT, Corsair, Fractal"
                  style={{
                    width: '100%',
                    padding: '12px',
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: H510, 4000D, Meshify C"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Boş kasanız için teklif talebiniz alındı. En kısa sürede size ulaşacağız.
            </p>
            <p style={{
              fontSize: '13px',
              color: '#059669',
