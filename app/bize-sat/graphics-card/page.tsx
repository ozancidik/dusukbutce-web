...
export default function BuyGraphicsCardPage() {
  // State'ler
  ...
  const isFormValid = useMemo(() => {
    ...
    if (!memoryValue || memoryValue.trim().length < 2) return false;
    if (!wattValue || wattValue.trim().length < 2) return false;
    if (!manufacturingYearValue || manufacturingYearValue.trim().length < 2) return false;
    return true;
  }, [brandValue, modelValue, memoryValue, wattValue, manufacturingYearValue]);
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: NVIDIA, AMD, ASUS, MSI..."
                value={brandValue}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: 8GB GDDR6, 12GB GDDR6X..."
                value={memoryValue}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: 115W, 200W, 350W..."
                value={wattValue}
