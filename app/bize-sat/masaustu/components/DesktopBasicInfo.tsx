...
export default function DesktopBasicInfo({ 
  isMobile, 
  formData, 
  onInputChange 
      ...
      <div style={{
        ...
        <div>
          ...
          <input
            ...
            placeholder="Örn: Intel i7-12700K, AMD Ryzen 7 5800X"
            style={{
              width: '100%',
              padding: '12px',
              border: '1px solid #d1d5db',
        ...
        <div>
          ...
          <input
            ...
            placeholder="Örn: RTX 3080, RX 6800 XT"
            style={{
              width: '100%',
              padding: '12px',
              border: '1px solid #d1d5db',
        ...
        <div>
          ...
          <input
            ...
            placeholder="Örn: 1TB SSD, 500GB NVMe"
            style={{
              width: '100%',
              padding: '12px',
              border: '1px solid #d1d5db',
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => onInputChange('motherboard', e.target.value)}
            placeholder="Örn: ASUS ROG Strix B550-F"
            style={{
              width: '100%',
              padding: '12px',
              border: '1px solid #d1d5db',
        ...
        <div>
          ...
          <input
            type="text"
            value={formData.case}
            onChange={(e) => onInputChange('case', e.target.value)}
            placeholder="Örn: Fractal Design Define 7"
            style={{
              width: '100%',
              padding: '12px',
              border: '1px solid #d1d5db',
        ...
        <div style={{ gridColumn: isMobile ? '1' : '1 / -1' }}>
          ...
          <textarea
            ...
            placeholder="Bilgisayarınız hakkında ek bilgiler..."
            rows={4}
            style={{
              width: '100%',
              padding: '12px',
