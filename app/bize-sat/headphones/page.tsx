...
export default function BuyHeadphonesPage() {
  ...
  const isFormValid = useMemo(() => {
    ...
    if (!typeValue || typeValue.trim().length < 2) return false;
    if (!manufacturingYearValue || manufacturingYearValue.trim().length < 2) return false;
    return true;
  }, [brandValue, modelValue, typeValue, manufacturingYearValue]);
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: Sony, Bose, Sennheiser, Audio-Technica..."
                value={brandValue}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: WH-1000XM4, QuietComfort 35, HD 660S..."
                value={modelValue}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: Over-ear, In-ear, On-ear, Wireless..."
                value={typeValue}
