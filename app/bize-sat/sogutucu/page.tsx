...
export default function CoolerPage() {
  ...
  const handleInputChange = (field: string, value: any) => {
    ...
    localStorage.setItem('coolerFormData', JSON.stringify(newData));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!isLoggedIn) {
      router.push('/login?returnUrl=' + encodeURIComponent('/bize-sat/sogutucu'));
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPopupMessage('Soğutucu ürününüz için teklif talebiniz alındı. En kısa sürede size dönüş yapacağız.');
        setShowPopup(true);
        
        localStorage.removeItem('coolerFormData');
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Soğutucunuzu satın, en iyi fiyatı alın
          </p>
        </div>
        ...
        {!isLoggedIn && (
          <div style={{
            ...
            <button
              type="button"
              onClick={() => router.push(`/login?returnUrl=${encodeURIComponent('/bize-sat/sogutucu')}`)}
              style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Soğutucunuz için teklif talebiniz alındı. En kısa sürede size ulaşacağız.
            </p>
            <p style={{
              fontSize: '13px',
              color: '#059669',
