...
export default function HeadphonesPage() {
  ...
  useEffect(() => {
    ...
    const savedFormData = localStorage.getItem('headphonesFormData');
    if (savedFormData) {
          // JWT token al
    ...
    try {
        ...
        console.log('📝 Kaydedilmiş kulaklık form verileri yüklendi');
      } catch (error) {
  ...
  const handleInputChange = (field: string, value: any) => {
    ...
    localStorage.setItem('headphonesFormData', JSON.stringify(newData));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!isLoggedIn) {
      router.push('/login?returnUrl=' + encodeURIComponent('/bize-sat/kulaklik'));
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPopupMessage('Kulaklık ürününüz için teklif talebiniz alındı. En kısa sürede size dönüş yapacağız.');
        setShowPopup(true);
        
        localStorage.removeItem('headphonesFormData');
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Kulaklığınızı satın, en iyi fiyatı alın
          </p>
        </div>

        {/* Login Required Card */}
        {!isLoggedIn && <LoginRequiredCard isMobile={isMobile} returnUrl="/bize-sat/kulaklik" />}
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Bluetooth, Kablolu, Kablosuz"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Kulaklığınız için teklif talebiniz alındı. En kısa sürede size ulaşacağız.
            </p>
            <p style={{
              fontSize: '13px',
              color: '#059669',
