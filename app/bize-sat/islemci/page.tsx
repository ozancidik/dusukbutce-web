...
export default function ProcessorPage() {
  ...
  useEffect(() => {
    ...
    try {
        ...
        setFormData({
          ...
          warrantyDuration: parsedData.warrantyDuration || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!isLoggedIn) {
      router.push('/login?returnUrl=' + encodeURIComponent('/bize-sat/islemci'));
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPopupMessage('İşlemci ürününüz için teklif talebiniz alındı. En kısa sürede size dönüş yapacağız.');
        setShowPopup(true);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Login Required Card */}
        {!isLoggedIn && <LoginRequiredCard isMobile={isMobile} returnUrl="/bize-sat/islemci" />}
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: i7-12700K, Ryzen 7 5800X"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              İşlemciniz için teklif talebiniz alındı. En kısa sürede size ulaşacağız.
            </p>
            <p style={{
              fontSize: '13px',
              color: '#059669',
