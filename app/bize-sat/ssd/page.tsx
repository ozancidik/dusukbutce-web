...
export default function SsdPage() {
  ...
  useEffect(() => {
    ...
    const savedFormData = localStorage.getItem('ssdFormData');
    if (savedFormData) {
          // JWT token al
    ...
    try {
        ...
        console.log('📝 Kaydedilmiş SSD form verileri yüklendi');
      } catch (error) {
  ...
  const handleInputChange = (field: string, value: any) => {
    ...
    localStorage.setItem('ssdFormData', JSON.stringify(newData));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!isLoggedIn) {
      router.push('/login?returnUrl=' + encodeURIComponent('/bize-sat/ssd'));
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPopupMessage('SSD ürününüz için teklif talebiniz alındı. En kısa sürede size dönüş yapacağız.');
        setShowPopup(true);
        
        localStorage.removeItem('ssdFormData');
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            SSD'nizi satın, en iyi fiyatı alın
          </p>
        </div>

        {/* Login Required Card */}
        {!isLoggedIn && <LoginRequiredCard isMobile={isMobile} returnUrl="/bize-sat/ssd" />}
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Samsung, WD, Crucial"
                  style={{
                    width: '100%',
                    padding: '12px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              SSD'niz için teklif talebiniz alındı. En kısa sürede size ulaşacağız.
            </p>
            <p style={{
              fontSize: '13px',
              color: '#059669',
