  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Login Required Card */}
        {!isLoggedIn && <LoginRequiredCard isMobile={isMobile} returnUrl="/bize-sat/monitor" />}
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Samsung, LG, ASUS"
                  style={{
                    width: '100%',
                    padding: '12px',
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: Odyssey G7, 27GL850"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
            ...
            <div style={{
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Örn: HDMI, DisplayPort, USB"
                  style={{
                    width: '100%',
                    padding: '12px',
                    border: '1px solid #d1d5db',
