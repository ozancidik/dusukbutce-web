...
export default function BuyMonitorPage() {
  ...
  const isFormValid = useMemo(() => {
    ...
    if (!sizeValue || sizeValue.trim().length < 2) return false;
    if (!resolutionValue || resolutionValue.trim().length < 2) return false;
    if (!manufacturingYearValue || manufacturingYearValue.trim().length < 2) return false;
    return true;
  }, [brandValue, modelValue, sizeValue, resolutionValue, manufacturingYearValue]);
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: Samsung, LG, ASUS, AOC..."
                value={brandValue}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: Odyssey G7, UltraGear, VG279Q..."
                value={modelValue}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: 24 inç, 27 inç, 32 inç..."
                value={sizeValue}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: 1920x1080, 2560x1440, 3840x2160..."
