...
export default function BuyProcessorPage() {
  // State'ler
  ...
  const [coreCountValue, setCoreCountValue] = useState('');
  ...
  const isFormValid = useMemo(() => {
    ...
    if (!coreCountValue || coreCountValue.trim().length < 2) return false;
    if (!frequencyValue || frequencyValue.trim().length < 2) return false;
    if (!manufacturingYearValue || manufacturingYearValue.trim().length < 2) return false;
    return true;
  }, [brandValue, modelValue, coreCountValue, frequencyValue, manufacturingYearValue]);
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: i5-12400, Ryzen 5 5600..."
                value={modelValue}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: 6 çekirdek, 8 çekirdek..."
                value={coreCountValue}
                onChange={(e) => setCoreCountValue(e.target.value)}
                style={{
                  width: '100%',
                  padding: isMobile ? '14px 16px' : '16px 20px',
                  border: '1px solid #e2e8f0',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: 3.2 GHz, 4.0 GHz..."
