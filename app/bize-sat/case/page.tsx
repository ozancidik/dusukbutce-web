...
export default function BuyCasePage() {
  ...
  const isFormValid = useMemo(() => {
    ...
    return true;
  }, [brandValue, modelValue, sizeValue, manufacturingYearValue]);
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: NZXT, Fractal Design, Phanteks..."
                value={brandValue}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: H510, Define C, P300A..."
                value={modelValue}
