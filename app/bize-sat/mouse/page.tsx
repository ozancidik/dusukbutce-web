...
export default function BuyMousePage() {
  ...
  const isFormValid = useMemo(() => {
    ...
    if (!sensorTypeValue || sensorTypeValue.trim().length < 2) return false;
    if (!manufacturingYearValue || manufacturingYearValue.trim().length < 2) return false;
    return true;
  }, [brandValue, modelValue, sensorTypeValue, manufacturingYearValue]);
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: Logitech, Razer, SteelSeries, Zowie..."
                value={brandValue}
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: G Pro X Superlight, DeathAdder V3, EC2..."
                value={modelValue}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '16px' : '24px' }}>
            <div>
              ...
              <input
                type="text"
                placeholder="Örn: HERO 25K, Focus Pro 30K, PMW3360..."
                value={sensorTypeValue}
                onChange={(e) => setSensorTypeValue(e.target.value)}
                style={{
                  width: '100%',
                  padding: isMobile ? '14px 16px' : '16px 20px',
                  border: '1px solid #e2e8f0',
